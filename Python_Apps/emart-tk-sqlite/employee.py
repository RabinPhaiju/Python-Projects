...
class login_page:
    def __init__(self, top=None):
        ...
        self.button1.configure(activebackground="#1F4C6C")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#1F4C6C")
...
class bill_window:
    def __init__(self, top=None):
        ...
        self.button1.place(relx=0.831, rely=0.06, width=76, height=23)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#1F4C6C")
        self.button1.configure(cursor="hand2")
        ...
        self.button2.place(relx=0.315, rely=0.154, width=76, height=23)
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#1F4C6C")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="#ffffff")
        self.button2.configure(background="#1F4C6C")
        ...
        self.button3.configure(activebackground="#1F4C6C")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="#ffffff")
        self.button3.configure(background="#1F4C6C")
        ...
        self.button4.configure(activebackground="#1F4C6C")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="#ffffff")
        self.button4.configure(background="#1F4C6C")
        ...
        self.button5.configure(activebackground="#1F4C6C")
        self.button5.configure(cursor="hand2")
        self.button5.configure(foreground="#ffffff")
        self.button5.configure(background="#1F4C6C")
        ...
        self.button6.configure(activebackground="#1F4C6C")
        self.button6.configure(cursor="hand2")
        self.button6.configure(foreground="#ffffff")
        self.button6.configure(background="#1F4C6C")
        ...
        self.button7.configure(activebackground="#1F4C6C")
        self.button7.configure(cursor="hand2")
        self.button7.configure(foreground="#ffffff")
        self.button7.configure(background="#1F4C6C")
        ...
        self.button8.configure(activebackground="#1F4C6C")
        self.button8.configure(cursor="hand2")
        self.button8.configure(foreground="#ffffff")
        self.button8.configure(background="#1F4C6C")
        ...
        self.button9.configure(activebackground="#1F4C6C")
        self.button9.configure(cursor="hand2")
        self.button9.configure(foreground="#ffffff")
        self.button9.configure(background="#1F4C6C")
        ...
        self.combo1.option_add("*TCombobox*Listbox.selectBackground", "#1F4C6C")
        ...
        self.entry8 = ttk.Entry(biller)
        self.entry8.place(relx=0.035, rely=0.336, width=477, height=26)
        ...
        self.Scrolledtext1.place(relx=0.439, rely=0.478, width=695, height=365)
        self.Scrolledtext1.configure(borderwidth=0)
        self.Scrolledtext1.configure(font="-family {Poppins} -size 10")
